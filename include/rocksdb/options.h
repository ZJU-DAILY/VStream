...
struct ColumnFamilyOptions : public AdvancedColumnFamilyOptions {
  virtual ~ColumnFamilyOptions() = default;
  ...
  virtual ColumnFamilyOptions* OldDefaults(int rocksdb_major_version = 4,
...
struct ReadOptions {
  enum ReadOptionsType { kDefault, kVectorSearch };
  virtual ReadOptionsType GetType() const { return kDefault; }
