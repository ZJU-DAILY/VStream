...
struct VectorColumnFamilyOptions;
...
class ColumnFamilyHandle {
 public:
  ...
  virtual Status GetDescriptor(
      VECTORBACKEND_NAMESPACE::VectorCFDescriptor* desc) {}
...
class DB {
 public:
  ...
  virtual Status SetVectorOptions(
      ColumnFamilyHandle* /*column_family*/,
      const std::unordered_map<std::string, std::string>& /*opts_map*/) {
    return Status::NotSupported("Not implemented");
  }
  ...
  virtual Status GetVectorOptions(
      ColumnFamilyHandle* column_family,
