...
class VectorColumnFamilyTestBase : public testing::Test {
 public:
  explicit VectorColumnFamilyTestBase(uint32_t format)
      : rnd_(139), format_(format) {
...
class VectorColumnFamilyTest
 ...
 public:
  VectorColumnFamilyTest() : VectorColumnFamilyTestBase(GetParam()) {}
};
...
TEST_P(VectorColumnFamilyTest, DontReuseColumnFamilyID) {
...
TEST_P(VectorColumnFamilyTest, CreateCFRaceWithGetAggProperty) {
  Open();

  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->LoadDependency(
      {{"DBImpl::WriteOptionsFile:1",
        "VectorColumnFamilyTest.CreateCFRaceWithGetAggProperty:1"},
       {"VectorColumnFamilyTest.CreateCFRaceWithGetAggProperty:2",
  ...
  TEST_SYNC_POINT("VectorColumnFamilyTest.CreateCFRaceWithGetAggProperty:1");
  uint64_t pv;
  db_->GetAggregatedIntProperty(DB::Properties::kEstimateTableReadersMem, &pv);
  TEST_SYNC_POINT("VectorColumnFamilyTest.CreateCFRaceWithGetAggProperty:2");
...
class FlushEmptyCFTestWithParam
 ...
 public:
  FlushEmptyCFTestWithParam()
      : VectorColumnFamilyTestBase(std::get<0>(GetParam())),
...
TEST_P(VectorColumnFamilyTest, AddDrop) {
  Open();
  CreateColumnFamilies({"one", "two", "three"});
...
TEST_P(VectorColumnFamilyTest, BulkAddDrop) {
...
TEST_P(VectorColumnFamilyTest, DropTest) {
...
TEST_P(VectorColumnFamilyTest, WriteBatchFailure) {
  Open();
...
TEST_P(VectorColumnFamilyTest, ReadWrite) {
  Open();
  CreateColumnFamiliesAndReopen({"one", "two"});
...
TEST_P(VectorColumnFamilyTest, IgnoreRecoveredLog) {
...
TEST_P(VectorColumnFamilyTest, FlushTest) {
  Open();
  CreateColumnFamiliesAndReopen({"one", "two"});
  ASSERT_OK(Put(0, "foo", "v1"));
  ASSERT_OK(Put(0, "bar", "v2"));
...
TEST_P(VectorColumnFamilyTest, LogDeletionTest) {
...
TEST_P(VectorColumnFamilyTest, CrashAfterFlush) {
  std::unique_ptr<FaultInjectionTestEnv> fault_env(
      new FaultInjectionTestEnv(env_));
  db_options_.env = fault_env.get();
  Open();
...
TEST_P(VectorColumnFamilyTest, OpenNonexistentColumnFamily) {
...
// Makes sure that obsolete log files get deleted
TEST_P(VectorColumnFamilyTest, DifferentWriteBufferSizes) {
...
// re-enable the test.
//
//   TEST_P(VectorColumnFamilyTest, MemtableNotSupportSnapshot) {
...
TEST_P(VectorColumnFamilyTest, GetComparator) {
  Open();
...
TEST_P(VectorColumnFamilyTest, DifferentMergeOperators) {
  Open();
...
TEST_P(VectorColumnFamilyTest, DifferentCompactionStyles) {
  Open();
  CreateColumnFamilies({"one", "two"});
...
TEST_P(VectorColumnFamilyTest, MultipleManualCompactions) {
  Open();
  CreateColumnFamilies({"one", "two"});
  ColumnFamilyOptions default_cf, one, two;
  db_options_.max_open_files = 20;  // only 10 files in file cache
  ...
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->LoadDependency(
      {{"VectorColumnFamilyTest::MultiManual:4",
        "VectorColumnFamilyTest::MultiManual:1"},
       {"VectorColumnFamilyTest::MultiManual:2",
        "VectorColumnFamilyTest::MultiManual:5"},
       {"VectorColumnFamilyTest::MultiManual:2",
        "VectorColumnFamilyTest::MultiManual:3"}});
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->SetCallBack(
      "DBImpl::BackgroundCompaction:NonTrivial:AfterRun", [&](void* /*arg*/) {
        if (cf_1_1.exchange(false)) {
          TEST_SYNC_POINT("VectorColumnFamilyTest::MultiManual:4");
          TEST_SYNC_POINT("VectorColumnFamilyTest::MultiManual:3");
        }
      });
  ...
  threads.emplace_back([&] {
    TEST_SYNC_POINT("VectorColumnFamilyTest::MultiManual:1");
    CompactRangeOptions compact_options;
    compact_options.exclusive_manual_compaction = false;
    ASSERT_OK(
        db_->CompactRange(compact_options, handles_[2], nullptr, nullptr));
    TEST_SYNC_POINT("VectorColumnFamilyTest::MultiManual:2");
  });

  TEST_SYNC_POINT("VectorColumnFamilyTest::MultiManual:5");
  for (auto& t : threads) {
    t.join();
  }
...
TEST_P(VectorColumnFamilyTest, AutomaticAndManualCompactions) {
  Open();
  CreateColumnFamilies({"one", "two"});
  ColumnFamilyOptions default_cf, one, two;
  db_options_.max_open_files = 20;  // only 10 files in file cache
  ...
  std::atomic_bool cf_1_1{true};
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->LoadDependency(
      {{"VectorColumnFamilyTest::AutoManual:4",
        "VectorColumnFamilyTest::AutoManual:1"},
       {"VectorColumnFamilyTest::AutoManual:2",
        "VectorColumnFamilyTest::AutoManual:5"},
       {"VectorColumnFamilyTest::AutoManual:2",
        "VectorColumnFamilyTest::AutoManual:3"}});
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->SetCallBack(
      "DBImpl::BackgroundCompaction:NonTrivial:AfterRun", [&](void* /*arg*/) {
        if (cf_1_1.exchange(false)) {
          TEST_SYNC_POINT("VectorColumnFamilyTest::AutoManual:4");
          TEST_SYNC_POINT("VectorColumnFamilyTest::AutoManual:3");
        }
      });
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->EnableProcessing();
  // SETUP column family "one" -- universal style
  ...
  TEST_SYNC_POINT("VectorColumnFamilyTest::AutoManual:1");
  ...
  ROCKSDB_NAMESPACE::port::Thread threads([&] {
    ...
    ASSERT_OK(
        db_->CompactRange(compact_options, handles_[2], nullptr, nullptr));
    TEST_SYNC_POINT("VectorColumnFamilyTest::AutoManual:2");
  });

  TEST_SYNC_POINT("VectorColumnFamilyTest::AutoManual:5");
  threads.join();
...
TEST_P(VectorColumnFamilyTest, ManualAndAutomaticCompactions) {
  Open();
  CreateColumnFamilies({"one", "two"});
  ColumnFamilyOptions default_cf, one, two;
  db_options_.max_open_files = 20;  // only 10 files in file cache
  ...
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->LoadDependency(
      {{"VectorColumnFamilyTest::ManualAuto:4",
        "VectorColumnFamilyTest::ManualAuto:1"},
       {"VectorColumnFamilyTest::ManualAuto:5",
        "VectorColumnFamilyTest::ManualAuto:2"},
       {"VectorColumnFamilyTest::ManualAuto:2",
        "VectorColumnFamilyTest::ManualAuto:3"}});
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->SetCallBack(
      "DBImpl::BackgroundCompaction:NonTrivial:AfterRun", [&](void* /*arg*/) {
        if (cf_1_1.exchange(false)) {
          TEST_SYNC_POINT("VectorColumnFamilyTest::ManualAuto:4");
          TEST_SYNC_POINT("VectorColumnFamilyTest::ManualAuto:3");
        } else if (cf_1_2.exchange(false)) {
          TEST_SYNC_POINT("VectorColumnFamilyTest::ManualAuto:2");
        }
      });
  ...
  TEST_SYNC_POINT("VectorColumnFamilyTest::ManualAuto:1");
  ...
  TEST_SYNC_POINT("VectorColumnFamilyTest::ManualAuto:5");
  threads.join();
...
TEST_P(VectorColumnFamilyTest, SameCFManualManualCompactions) {
  Open();
  CreateColumnFamilies({"one"});
  ...
  std::atomic_bool cf_1_2{true};
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->LoadDependency(
      {{"VectorColumnFamilyTest::ManualManual:4",
        "VectorColumnFamilyTest::ManualManual:2"},
       {"VectorColumnFamilyTest::ManualManual:4",
        "VectorColumnFamilyTest::ManualManual:5"},
       {"VectorColumnFamilyTest::ManualManual:1",
        "VectorColumnFamilyTest::ManualManual:2"},
       {"VectorColumnFamilyTest::ManualManual:1",
        "VectorColumnFamilyTest::ManualManual:3"}});
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->SetCallBack(
      "DBImpl::BackgroundCompaction:NonTrivial:AfterRun", [&](void* /*arg*/) {
        if (cf_1_1.exchange(false)) {
          TEST_SYNC_POINT("VectorColumnFamilyTest::ManualManual:4");
          TEST_SYNC_POINT("VectorColumnFamilyTest::ManualManual:3");
        } else if (cf_1_2.exchange(false)) {
          TEST_SYNC_POINT("VectorColumnFamilyTest::ManualManual:2");
        }
      });
  ...
  TEST_SYNC_POINT("VectorColumnFamilyTest::ManualManual:5");
  ...
  TEST_SYNC_POINT("VectorColumnFamilyTest::ManualManual:1");
...
TEST_P(VectorColumnFamilyTest, SameCFManualAutomaticCompactions) {
  Open();
  CreateColumnFamilies({"one"});
  ColumnFamilyOptions default_cf, one;
  db_options_.max_open_files = 20;  // only 10 files in file cache
...
TEST_P(VectorColumnFamilyTest, SameCFManualAutomaticCompactionsLevel) {
  Open();
  CreateColumnFamilies({"one"});
  ColumnFamilyOptions default_cf, one;
  db_options_.max_open_files = 20;  // only 10 files in file cache
...
TEST_P(VectorColumnFamilyTest, SameCFAutomaticManualCompactions) {
  Open();
  CreateColumnFamilies({"one"});
  ColumnFamilyOptions default_cf, one;
  db_options_.max_open_files = 20;  // only 10 files in file cache
...
TEST_P(VectorColumnFamilyTest, NewIteratorsTest) {
  // iter == 0 -- no tailing
  // iter == 2 -- tailing
  for (int iter = 0; iter < 2; ++iter) {
    Open();
...
TEST_P(VectorColumnFamilyTest, ReadOnlyDBTest) {
  Open();
...
TEST_P(VectorColumnFamilyTest, DontRollEmptyLogs) {
  Open();
  CreateColumnFamiliesAndReopen({"one", "two", "three", "four"});
...
TEST_P(VectorColumnFamilyTest, FlushStaleColumnFamilies) {
  Open();
  CreateColumnFamilies({"one", "two"});
  ColumnFamilyOptions default_cf, one, two;
...
TEST_P(VectorColumnFamilyTest, CreateMissingColumnFamilies) {
...
TEST_P(VectorColumnFamilyTest, SanitizeOptions) {
...
TEST_P(VectorColumnFamilyTest, ReadDroppedColumnFamily) {
...
TEST_P(VectorColumnFamilyTest, LiveIteratorWithDroppedColumnFamily) {
  db_options_.create_missing_column_families = true;
  db_options_.max_open_files = 20;
  // delete obsolete files always
  db_options_.delete_obsolete_files_period_micros = 0;
...
TEST_P(VectorColumnFamilyTest, FlushAndDropRaceCondition) {
  db_options_.create_missing_column_families = true;
  Open({"default", "one"});
  ColumnFamilyOptions options;
  options.level0_file_num_compaction_trigger = 100;
...
void DropSingleColumnFamily(VectorColumnFamilyTest* cf_test, int cf_id,
...
TEST_P(VectorColumnFamilyTest, CreateAndDropRace) {
...
TEST_P(VectorColumnFamilyTest, WriteStallSingleColumnFamily) {
...
TEST_P(VectorColumnFamilyTest, CompactionSpeedupSingleColumnFamily) {
  db_options_.max_background_compactions = 6;
  Open({"default"});
  ColumnFamilyData* cfd =
      static_cast<ColumnFamilyHandleImpl*>(db_->DefaultColumnFamily())->cfd();
...
TEST_P(VectorColumnFamilyTest, WriteStallTwoColumnFamilies) {
...
TEST_P(VectorColumnFamilyTest, CompactionSpeedupTwoColumnFamilies) {
  db_options_.max_background_compactions = 6;
...
TEST_P(VectorColumnFamilyTest, CreateAndDestroyOptions) {
...
TEST_P(VectorColumnFamilyTest, CreateDropAndDestroy) {
  ColumnFamilyHandle* cfh;
  Open();
...
TEST_P(VectorColumnFamilyTest, CreateDropAndDestroyWithoutFileDeletion) {
  ColumnFamilyHandle* cfh;
  Open();
  ASSERT_OK(db_->CreateColumnFamily(ColumnFamilyOptions(), "yoyo", &cfh));
  ASSERT_OK(db_->Put(WriteOptions(), cfh, "foo", "bar"));
...
TEST_P(VectorColumnFamilyTest, FlushCloseWALFiles) {
...
TEST_P(VectorColumnFamilyTest, IteratorCloseWALFile1) {
  SpecialEnv env(Env::Default());
  db_options_.env = &env;
  db_options_.max_background_flushes = 1;
  column_family_options_.memtable_factory.reset(
...
TEST_P(VectorColumnFamilyTest, IteratorCloseWALFile2) {
  SpecialEnv env(Env::Default());
  ...
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->LoadDependency({
      {"VectorColumnFamilyTest::IteratorCloseWALFile2:0",
       "DBImpl::BGWorkPurge:start"},
      {"VectorColumnFamilyTest::IteratorCloseWALFile2:2",
       "DBImpl::BackgroundCallFlush:start"},
      {"DBImpl::BGWorkPurge:end",
       "VectorColumnFamilyTest::IteratorCloseWALFile2:1"},
  });
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->EnableProcessing();
  ...
  TEST_SYNC_POINT("VectorColumnFamilyTest::IteratorCloseWALFile2:0");
  TEST_SYNC_POINT("VectorColumnFamilyTest::IteratorCloseWALFile2:1");
  ASSERT_EQ(1, env.num_open_wal_file_.load());
  TEST_SYNC_POINT("VectorColumnFamilyTest::IteratorCloseWALFile2:2");
  WaitForFlush(1);
  ASSERT_EQ(1, env.num_open_wal_file_.load());
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->DisableProcessing();
...
TEST_P(VectorColumnFamilyTest, ForwardIteratorCloseWALFile) {
  SpecialEnv env(Env::Default());
  // Allow both of flush and purge job to schedule.
  env.SetBackgroundThreads(2, Env::HIGH);
  db_options_.env = &env;
...
#ifndef OS_WIN
TEST_P(VectorColumnFamilyTest, LogSyncConflictFlush) {
  Open();
  CreateColumnFamiliesAndReopen({"one", "two"});
  ...
  ROCKSDB_NAMESPACE::SyncPoint::GetInstance()->LoadDependency(
      {{"DBImpl::SyncWAL:BeforeMarkLogsSynced:1",
        "VectorColumnFamilyTest::LogSyncConflictFlush:1"},
       {"VectorColumnFamilyTest::LogSyncConflictFlush:2",
  ...
  TEST_SYNC_POINT("VectorColumnFamilyTest::LogSyncConflictFlush:1");
  ASSERT_OK(Flush(1));
  ASSERT_OK(Put(1, "foo", "bar"));
  ASSERT_OK(Flush(1));

  TEST_SYNC_POINT("VectorColumnFamilyTest::LogSyncConflictFlush:2");
...
// ignored
TEST_P(VectorColumnFamilyTest, DISABLED_LogTruncationTest) {
  Open();
  CreateColumnFamiliesAndReopen({"one", "two"});
...
TEST_P(VectorColumnFamilyTest, DefaultCfPathsTest) {
  Open();
...
TEST_P(VectorColumnFamilyTest, MultipleCFPathsTest) {
  Open();
...
TEST(VectorColumnFamilyTest, ValidateBlobGCCutoff) {
  DBOptions db_options;
...
TEST(VectorColumnFamilyTest, ValidateBlobGCForceThreshold) {
  DBOptions db_options;
...
TEST(VectorColumnFamilyTest, ValidateMemtableKVChecksumOption) {
  DBOptions db_options;
