...
#include "plugin/vectorbackend/table/hnsw_block_cache.h"
...
const std::array<const Cache::CacheItemHelper*,
    ...
    kCacheItemFullHelperForBlockType{{
        ...
        BlockCacheInterface<
            VECTORBACKEND_NAMESPACE::Block_kHnsw>::GetFullHelper(),
        nullptr,  // kInvalid
    }};
...
const std::array<const Cache::CacheItemHelper*,
    ...
    kCacheItemBasicHelperForBlockType{{
        ...
        BlockCacheInterface<
            VECTORBACKEND_NAMESPACE::Block_kHnsw>::GetBasicHelper(),
        nullptr,  // kInvalid
    }};
}  // namespace
