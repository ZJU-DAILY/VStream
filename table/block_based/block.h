...
class HnswIndexBlockIter;
class GorillaCompressedDataBlockIter;
...
class Block {
 public:
  ...
  VECTORBACKEND_NAMESPACE::GorillaCompressedDataBlockIter*
  NewGorillaCompressedDataBlockIterator(
      VECTORBACKEND_NAMESPACE::GorillaCompressedDataBlockIter* iter,
      const vectorbackend::HnswTableOptions* hnsw_options,
      const std::string& table_name, bool block_contents_pinned = false);

  VECTORBACKEND_NAMESPACE::HnswIndexBlockIter* NewHnswIndexBlockIterator(
      VECTORBACKEND_NAMESPACE::HnswIndexBlockIter* iter,
      bool block_contents_pinned = false);
