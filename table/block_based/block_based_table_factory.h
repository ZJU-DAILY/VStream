...
class BlockBasedTableFactory : public TableFactory {
 ...
 protected:
  ...
  // Convert private to protected so that subclasses can access it
...
extern const std::string kOptNameMetadataCacheOpts;
extern const std::unordered_map<std::string, BlockBasedTableOptions::IndexType>
...
extern const std::unordered_map<std::string, OptionTypeInfo>
