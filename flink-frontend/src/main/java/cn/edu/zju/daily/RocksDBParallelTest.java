...
public class RocksDBParallelTest {
                ...
                new RocksDBOptionsFactory() {
                    ...
                    public VectorColumnFamilyOptions createVectorColumnOptions(
                        ...
                        currentOptions.setMemTableConfig(
                                new HnswMemTableConfig(dim).setSpace(SpaceType.L2)
                                        .setM(m)
                        ...
                        currentOptions.setTableFormatConfig(new HnswTableOptions()
                                ...
                                .setBlockCache(new LRUCache(blockCacheSize))  // 1 GB block cache
                        );
    ...
    static private class InsertRunner implements Runnable {
        ...
        public void run() {
            ...
            String dir = "./tmp/rocksdb-standalone-"
            ...
            if (doInsert) {
                ...
                try {
                    vectors = FloatVectorIterator.fromFile(
...
//            flush();
    ...
    static private class SearchRunner implements Runnable {
        ...
        public void run() {
            ...
            try {
                queries = FloatVectorIterator.fromFile(
...
//            SearchResult gt = gts.next();
                ...
                System.out.println("Query " + query.getId() + " done in " + (System.currentTimeMillis() - start) + " ms: " + result);

//            accuracies.add(SearchResult.getAccuracy(result, gt));
//
//            if (query.getId() % 100 == 99) {
//                System.out.println((query.getId() + 1) + " queries: " + accuracies);
//                // average
