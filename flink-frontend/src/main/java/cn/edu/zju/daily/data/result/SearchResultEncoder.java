...
public class SearchResultEncoder implements Encoder<SearchResult> {
    ...
    /**
     * Creates a new {@code SearchResultEncoder} that uses {@code "UTF-8"} charset to convert
     * strings to bytes.
     */
    ...
    /**
     * Creates a new {@code SearchResultEncoder} that uses the given charset to convert strings to
     * bytes.
     *
