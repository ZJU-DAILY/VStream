...
import cn.edu.zju.daily.pipeline.QdrantSeparatedStreamingPipeline;
...
public class QdrantSeparatedStreamSearchJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        QdrantSeparatedStreamingPipeline pipeline = new QdrantSeparatedStreamingPipeline(params);
        ...
        env.executeAsync("QdrantSeparatedStreamSearchJob");
    }
}
