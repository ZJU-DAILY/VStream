...
public interface PartitionFunction extends CoFlatMapFunction<FloatVector, FloatVector, PartitionedData>,
    ...
    static FlatMapFunction<FloatVector, PartitionedData> getUnaryPartitionFunction(Parameters params, Random random, boolean isQuery) {
        switch (params.getPartitioner()) {
            case "lsh+hilbert":
                return new MultiplexLSHHilbertPartitionFunction(random, params.getVectorDim(), params.getLshNumFamilies(), params.getLshNumHashes(),
                        params.getLshBucketWidth(), params.getLshNumHilbertBits(), params.getLshPartitionUpdateInterval(),
                        params.getLshHilbertMaxRetainedElements(), params.getMaxTTL(), params.getParallelism(), isQuery);
            default:
                throw new RuntimeException("Partitioner " + params.getPartitioner() + " not supported.");
        }
    }
    ...
    static PartitionFunction getPartitionFunction(Parameters params, Random random) {
        switch (params.getPartitioner()) {
            case "lsh":
                return new LSHPartitionFunction(random, params.getVectorDim(),
                        params.getNumCopies(), params.getLshNumHashes(), params.getParallelism(), params.getLshBucketWidth());
            case "lsh+random":
                return new LSHAndRandomPartitionFunction(random, params.getVectorDim(),
                        params.getNumCopies(), params.getLshNumHashes(), params.getParallelism(), params.getLshBucketWidth());
            case "lsh+proximity":
                return new LSHProximityPartitionFunction(random, params.getVectorDim(),
                        params.getNumCopies(), params.getLshNumHashes(), params.getParallelism(), params.getLshBucketWidth(),
                        params.getProximity());
            case "lsh+hilbert":
                long fakeInsertInterval = rateToInterval(params.getFakeInsertRate());
                return new LSHHilbertPartitionFunction(random, params.getVectorDim(), params.getLshNumFamilies(), params.getLshNumHashes(),
                        params.getLshBucketWidth(), params.getLshNumHilbertBits(), params.getLshPartitionUpdateInterval(),
                        params.getLshHilbertMaxRetainedElements(), params.getMaxTTL(), fakeInsertInterval, params.getParallelism());
            case "simple":
