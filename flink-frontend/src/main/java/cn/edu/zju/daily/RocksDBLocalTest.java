...
public class RocksDBLocalTest {
    ...
    static void openDB(String dir, boolean create) throws RocksDBException {
        container = new RocksDBResourceContainer(PredefinedOptions.DEFAULT,
    ...
    static private void insert(FloatVector vector) {
    ...
    static private SearchResult search(FloatVector query) {
        ...
        return DataSerializer.deserializeSearchResult(resultBytes, 0, query.getId(), 1, query.getEventTime());
    }
