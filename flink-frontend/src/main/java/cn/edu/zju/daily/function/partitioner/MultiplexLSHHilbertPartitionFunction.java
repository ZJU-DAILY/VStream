...
public class MultiplexLSHHilbertPartitionFunction implements FlatMapFunction<FloatVector, PartitionedData>,
     ...
     */
    public MultiplexLSHHilbertPartitionFunction(Random random,
                                                int dim,
                                                int numHashFamilies,
...
//        }
        ...
        LOG.info("Initializing LSHHilbertPartitionFunction with dim: {}, numHashFamilies: {}, numHashFunctions: {}, " +
                        "hashWidth: {}, numHilbertBits: {}, updateInterval: {}, maxRetainedElements: {}, maxTTL: {}, numPartitions: {}",
                dim, numHashFamilies, numHashFunctions, hashWidth, numHilbertBits, updateInterval, maxRetainedElements, maxTTL, numPartitions);
...
//            LOG.info("Partition: {} -> {} (ts: {})", value.getId(), partition, value.getEventTime());
