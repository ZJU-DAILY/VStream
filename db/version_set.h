...
class VersionStorageInfo {
 ...
 private:
  ...
  mutable std::shared_mutex level_files_lock_;
...
class VersionSet {
 public:
  VersionSet(const std::string& dbname, const ImmutableDBOptions* db_options,
             ...
             const std::unordered_map<
                 uint32_t, VECTORBACKEND_NAMESPACE::VectorColumnFamilyInfo>*
                 vcf_info = nullptr,
             port::Mutex* vcf_mutex = nullptr);
  // No copying allowed
 ...
 protected:
  ...
  const std::unordered_map<
      uint32_t, VECTORBACKEND_NAMESPACE::VectorColumnFamilyInfo>* vcf_info_;
