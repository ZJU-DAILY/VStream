...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    //    {BLOCK_CACHE_VECTOR_INDEX_MISS,
    //    "rocksdb.block.cache.vectorindex.miss"},
    //    {BLOCK_CACHE_VECTOR_INDEX_HIT, "rocksdb.block.cache.vectorindex.hit"},
    //    {BLOCK_CACHE_VECTOR_INDEX_ADD, "rocksdb.block.cache.vectorindex.add"},
    //    {BLOCK_CACHE_VECTOR_INDEX_BYTES_INSERT,
    //     "rocksdb.block.cache.vectorindex.bytes.insert"},
    ...
    //     "rocksdb.block.cache.vectorindex.add.redundant"},
