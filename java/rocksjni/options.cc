 ...
 * Signature: (JI)V
 */
void Java_org_rocksdb_Options_setFlushThreshold(JNIEnv*, jobject, jlong jhandle,
                                                jint jflush_threshold) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  opts->flush_threshold = static_cast<int>(jflush_threshold);
}
 ...
 * Signature: (J)I
 */
jint Java_org_rocksdb_Options_flushThreshold(JNIEnv*, jobject, jlong jhandle) {
  auto* opts = reinterpret_cast<ROCKSDB_NAMESPACE::Options*>(jhandle);
  return static_cast<jint>(opts->flush_threshold);
}
 ...
 * Signature: (JI)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setFlushThreshold(
 ...
 * Signature: (J)I
 */
jint Java_org_rocksdb_ColumnFamilyOptions_flushThreshold(JNIEnv*, jobject,
                                                         jlong jhandle) {
  auto* opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::ColumnFamilyOptions*>(jhandle);
  return static_cast<jint>(opts->flush_threshold);
