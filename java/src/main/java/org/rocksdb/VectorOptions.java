 ...
 */
public class VectorOptions extends RocksObject implements DBOptionsInterface<VectorOptions>,
        MutableDBOptionsInterface<VectorOptions>, VectorColumnFamilyOptionsInterface<VectorOptions>,
        MutableVectorColumnFamilyOptionsInterface<VectorOptions> {
    static {
        RocksDB.loadLibrary();
    }
     ...
     * @param vectorColumnFamilyOptions {@link VectorColumnFamilyOptions}
     *                                  instance
     */
    public VectorOptions(final DBOptions dbOptions, final VectorColumnFamilyOptions vectorColumnFamilyOptions) {
        super(newVectorOptions(dbOptions.nativeHandle_, vectorColumnFamilyOptions.nativeHandle_));
     ...
     */
    public VectorOptions(final VectorOptions other) {
        super(copyVectorOptions(other.nativeHandle_));
    ...
    private static native long newVectorOptions();

    private static native long newVectorOptions(long dbOptHandle, long cfOptHandle);

    private static native long copyVectorOptions(long handle);
    ...
    private static native void setEventListeners(final long handle, final long[] eventListenerHandles);

    private static native AbstractEventListener[] eventListeners(final long handle);

    private static native void setSkipCheckingSstFileSizesOnDbOpen(final long handle, final boolean skipChecking);
    ...
    private static native void setCfPaths(final long handle, final String[] paths, final long[] targetSizes);

    private static native long cfPathsLen(final long handle);

    private static native void cfPaths(final long handle, final String[] paths, final long[] targetSizes);

    private static native void setCompactionThreadLimiter(final long nativeHandle_, final long newLimiterHandle);

    private static native void setAvoidUnnecessaryBlockingIO(final long handle, final boolean avoidBlockingIO);

    private static native boolean avoidUnnecessaryBlockingIO(final long handle);

    private static native void setPersistStatsToDisk(final long handle, final boolean persistStatsToDisk);

    private static native boolean persistStatsToDisk(final long handle);

    private static native void setWriteDbidToManifest(final long handle, final boolean writeDbidToManifest);
    ...
    private static native void setBestEffortsRecovery(final long handle, final boolean bestEffortsRecovery);

    private static native boolean bestEffortsRecovery(final long handle);

    private static native void setMaxBgErrorResumeCount(final long handle, final int maxBgerrorRecumeCount);

    private static native int maxBgerrorResumeCount(final long handle);

    private static native void setBgerrorResumeRetryInterval(final long handle, final long bgerrorResumeRetryInterval);

    private static native long bgerrorResumeRetryInterval(final long handle);

    @Override
    public VectorOptions setIncreaseParallelism(final int totalThreads) {
    ...
    @Override
    public VectorOptions setCreateIfMissing(final boolean flag) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setCreateMissingColumnFamilies(final boolean flag) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setEnv(final Env env) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions oldDefaults(final int majorVersion, final int minorVersion) {
        return this;
    }

    @Override
    public VectorOptions optimizeForSmallDb() {
        optimizeForSmallDb(nativeHandle_);
        return this;
    }

    @Override
    public VectorOptions optimizeForSmallDb(final Cache cache) {
        optimizeForSmallDb(nativeHandle_, cache.getNativeHandle());
        return this;
    }

    @Override
    public VectorOptions optimizeForPointLookup(final long blockCacheSizeMb) {
        optimizeForPointLookup(nativeHandle_, blockCacheSizeMb);
        return this;
    }

    @Override
    public VectorOptions optimizeLevelStyleCompaction() {
        optimizeLevelStyleCompaction(nativeHandle_, DEFAULT_COMPACTION_MEMTABLE_MEMORY_BUDGET);
        return this;
    }

    @Override
    public VectorOptions optimizeLevelStyleCompaction(final long memtableMemoryBudget) {
        optimizeLevelStyleCompaction(nativeHandle_, memtableMemoryBudget);
        return this;
    }

    @Override
    public VectorOptions optimizeUniversalStyleCompaction() {
        optimizeUniversalStyleCompaction(nativeHandle_, DEFAULT_COMPACTION_MEMTABLE_MEMORY_BUDGET);
        return this;
    }

    @Override
    public VectorOptions optimizeUniversalStyleCompaction(final long memtableMemoryBudget) {
        optimizeUniversalStyleCompaction(nativeHandle_, memtableMemoryBudget);
        return this;
    }

    @Override
    public VectorOptions setComparator(final BuiltinComparator builtinComparator) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setComparator(final AbstractComparator comparator) {
        assert (isOwningHandle());
        setComparatorHandle(nativeHandle_, comparator.nativeHandle_, comparator.getComparatorType().getValue());
        comparator_ = comparator;
        return this;
    }

    @Override
    public VectorOptions setMergeOperatorName(final String name) {
        assert (isOwningHandle());
        if (name == null) {
    ...
    @Override
    public VectorOptions setMergeOperator(final MergeOperator mergeOperator) {
        setMergeOperator(nativeHandle_, mergeOperator.nativeHandle_);
        return this;
    }

    @Override
    public VectorOptions setCompactionFilter(final AbstractCompactionFilter<? extends AbstractSlice<?>> compactionFilter) {
    ...
    @Override
    public VectorOptions setCompactionFilterFactory(final AbstractCompactionFilterFactory<?
    ...
    @Override
    public VectorOptions setWriteBufferSize(final long writeBufferSize) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setMaxWriteBufferNumber(final int maxWriteBufferNumber) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setErrorIfExists(final boolean errorIfExists) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setParanoidChecks(final boolean paranoidChecks) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setMaxFileOpeningThreads(final int maxFileOpeningThreads) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setMaxTotalWalSize(final long maxTotalWalSize) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setMaxOpenFiles(final int maxOpenFiles) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setUseFsync(final boolean useFsync) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setDbPaths(final Collection<DbPath> dbPaths) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setDbLogDir(final String dbLogDir) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setWalDir(final String walDir) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setDeleteObsoleteFilesPeriodMicros(final long micros) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setStatistics(final Statistics statistics) {
        assert (isOwningHandle());
    ...
    @Override
    @Deprecated
    public VectorOptions setMaxBackgroundCompactions(final int maxBackgroundCompactions) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setMaxSubcompactions(final int maxSubcompactions) {
        assert (isOwningHandle());
    ...
    @Override
    @Deprecated
    public VectorOptions setMaxBackgroundFlushes(final int maxBackgroundFlushes) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setMaxBackgroundJobs(final int maxBackgroundJobs) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setMaxLogFileSize(final long maxLogFileSize) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setLogFileTimeToRoll(final long logFileTimeToRoll) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setKeepLogFileNum(final long keepLogFileNum) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setRecycleLogFileNum(final long recycleLogFileNum) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setMaxManifestFileSize(final long maxManifestFileSize) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setMaxTableFilesSizeFIFO(final long maxTableFilesSize) {
    ...
    @Override
    public VectorOptions setTableCacheNumshardbits(final int tableCacheNumshardbits) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setWalTtlSeconds(final long walTtlSeconds) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setMaxWriteBatchGroupSizeBytes(final long maxWriteBatchGroupSizeBytes) {
    ...
    @Override
    public VectorOptions setWalSizeLimitMB(final long sizeLimitMB) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setManifestPreallocationSize(final long size) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setUseDirectReads(final boolean useDirectReads) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setUseDirectIoForFlushAndCompaction(final boolean useDirectIoForFlushAndCompaction) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setAllowFAllocate(final boolean allowFAllocate) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setAllowMmapReads(final boolean allowMmapReads) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setAllowMmapWrites(final boolean allowMmapWrites) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setIsFdCloseOnExec(final boolean isFdCloseOnExec) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setStatsDumpPeriodSec(final int statsDumpPeriodSec) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setStatsPersistPeriodSec(final int statsPersistPeriodSec) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setStatsHistoryBufferSize(final long statsHistoryBufferSize) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setAdviseRandomOnOpen(final boolean adviseRandomOnOpen) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setDbWriteBufferSize(final long dbWriteBufferSize) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setWriteBufferManager(final WriteBufferManager writeBufferManager) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setAccessHintOnCompactionStart(final AccessHint accessHint) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setCompactionReadaheadSize(final long compactionReadaheadSize) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setRandomAccessMaxBufferSize(final long randomAccessMaxBufferSize) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setWritableFileMaxBufferSize(final long writableFileMaxBufferSize) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setUseAdaptiveMutex(final boolean useAdaptiveMutex) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setBytesPerSync(final long bytesPerSync) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setWalBytesPerSync(final long walBytesPerSync) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setStrictBytesPerSync(final boolean strictBytesPerSync) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setListeners(final List<AbstractEventListener> listeners) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setEnableThreadTracking(final boolean enableThreadTracking) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setDelayedWriteRate(final long delayedWriteRate) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setEnablePipelinedWrite(final boolean enablePipelinedWrite) {
    ...
    @Override
    public VectorOptions setUnorderedWrite(final boolean unorderedWrite) {
    ...
    @Override
    public VectorOptions setAllowConcurrentMemtableWrite(final boolean allowConcurrentMemtableWrite) {
        setAllowConcurrentMemtableWrite(nativeHandle_, allowConcurrentMemtableWrite);
        return this;
    }
    ...
    @Override
    public VectorOptions setEnableWriteThreadAdaptiveYield(final boolean enableWriteThreadAdaptiveYield) {
        setEnableWriteThreadAdaptiveYield(nativeHandle_, enableWriteThreadAdaptiveYield);
        return this;
    }
    ...
    @Override
    public VectorOptions setWriteThreadMaxYieldUsec(final long writeThreadMaxYieldUsec) {
    ...
    @Override
    public VectorOptions setWriteThreadSlowYieldUsec(final long writeThreadSlowYieldUsec) {
    ...
    @Override
    public VectorOptions setSkipStatsUpdateOnDbOpen(final boolean skipStatsUpdateOnDbOpen) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setSkipCheckingSstFileSizesOnDbOpen(final boolean skipCheckingSstFileSizesOnDbOpen) {
    ...
    @Override
    public VectorOptions setWalRecoveryMode(final WALRecoveryMode walRecoveryMode) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setAllow2pc(final boolean allow2pc) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setRowCache(final Cache rowCache) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setWalFilter(final AbstractWalFilter walFilter) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setFailIfOptionsFileError(final boolean failIfOptionsFileError) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setDumpMallocStats(final boolean dumpMallocStats) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setAvoidFlushDuringRecovery(final boolean avoidFlushDuringRecovery) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setAvoidFlushDuringShutdown(final boolean avoidFlushDuringShutdown) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setAllowIngestBehind(final boolean allowIngestBehind) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setTwoWriteQueues(final boolean twoWriteQueues) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setManualWalFlush(final boolean manualWalFlush) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setMemTableConfig(final MemTableConfig config) {
    ...
    @Override
    public VectorOptions setRateLimiter(final RateLimiter rateLimiter) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setSstFileManager(final SstFileManager sstFileManager) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setLogger(final Logger logger) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setInfoLogLevel(final InfoLogLevel infoLogLevel) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setTableFormatConfig(final TableFormatConfig config) {
    ...
    @Override
    public VectorOptions setCfPaths(final Collection<DbPath> cfPaths) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions useFixedLengthPrefixExtractor(final int n) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions useCappedPrefixExtractor(final int n) {
        assert (isOwningHandle());
    ...
    @Override
    public VectorOptions setFlushThreshold(int flushThreshold) {
        setFlushThreshold(nativeHandle_, flushThreshold);
        return this;
    }

    @Override
    public VectorOptions setCompressionPerLevel(final List<CompressionType> compressionLevels) {
    ...
    @Override
    public VectorOptions setCompressionType(final CompressionType compressionType) {
        setCompressionType(nativeHandle_, compressionType.getValue());
        return this;
    }

    @Override
    public VectorOptions setBottommostCompressionType(final CompressionType bottommostCompressionType) {
        setBottommostCompressionType(nativeHandle_, bottommostCompressionType.getValue());
        return this;
    }

    @Override
    public CompressionType bottommostCompressionType() {
        return CompressionType.getCompressionType(bottommostCompressionType(nativeHandle_));
    }

    @Override
    public VectorOptions setBottommostCompressionOptions(final CompressionOptions bottommostCompressionOptions) {
    ...
    @Override
    public VectorOptions setCompressionOptions(final CompressionOptions compressionOptions) {
    ...
    @Override
    public VectorOptions setCompactionStyle(final CompactionStyle compactionStyle) {
    ...
    @Override
    public VectorOptions setNumLevels(final int numLevels) {
    ...
    @Override
    public VectorOptions setLevelZeroFileNumCompactionTrigger(final int numFiles) {
        setLevelZeroFileNumCompactionTrigger(nativeHandle_, numFiles);
        return this;
    }
    ...
    @Override
    public VectorOptions setLevelZeroSlowdownWritesTrigger(final int numFiles) {
    ...
    @Override
    public VectorOptions setLevelZeroStopWritesTrigger(final int numFiles) {
    ...
    @Override
    public VectorOptions setTargetFileSizeBase(final long targetFileSizeBase) {
    ...
    @Override
    public VectorOptions setTargetFileSizeMultiplier(final int multiplier) {
        setTargetFileSizeMultiplier(nativeHandle_, multiplier);
        return this;
    }

    @Override
    public VectorOptions setMaxBytesForLevelBase(final long maxBytesForLevelBase) {
    ...
    @Override
    public VectorOptions setLevelCompactionDynamicLevelBytes(final boolean enableLevelCompactionDynamicLevelBytes) {
        setLevelCompactionDynamicLevelBytes(nativeHandle_, enableLevelCompactionDynamicLevelBytes);
        return this;
    }
    ...
    @Override
    public VectorOptions setMaxBytesForLevelMultiplier(final double multiplier) {
    ...
    @Override
    public VectorOptions setMaxCompactionBytes(final long maxCompactionBytes) {
    ...
    @Override
    public VectorOptions setArenaBlockSize(final long arenaBlockSize) {
    ...
    @Override
    public VectorOptions setDisableAutoCompactions(final boolean disableAutoCompactions) {
    ...
    @Override
    public VectorOptions setMaxSequentialSkipInIterations(final long maxSequentialSkipInIterations) {
    ...
    @Override
    public VectorOptions setInplaceUpdateSupport(final boolean inplaceUpdateSupport) {
    ...
    @Override
    public VectorOptions setInplaceUpdateNumLocks(final long inplaceUpdateNumLocks) {
    ...
    @Override
    public VectorOptions setMemtablePrefixBloomSizeRatio(final double memtablePrefixBloomSizeRatio) {
    ...
    @Override
    public VectorOptions setExperimentalMempurgeThreshold(final double experimentalMempurgeThreshold) {
    ...
    @Override
    public VectorOptions setMemtableWholeKeyFiltering(final boolean memtableWholeKeyFiltering) {
    ...
    @Override
    public VectorOptions setBloomLocality(final int bloomLocality) {
    ...
    @Override
    public VectorOptions setMaxSuccessiveMerges(final long maxSuccessiveMerges) {
    ...
    @Override
    public VectorOptions setMinWriteBufferNumberToMerge(final int minWriteBufferNumberToMerge) {
        setMinWriteBufferNumberToMerge(nativeHandle_, minWriteBufferNumberToMerge);
        return this;
    }

    @Override
    public VectorOptions setOptimizeFiltersForHits(final boolean optimizeFiltersForHits) {
    ...
    @Override
    public VectorOptions setMemtableHugePageSize(final long memtableHugePageSize) {
        setMemtableHugePageSize(nativeHandle_, memtableHugePageSize);
        return this;
    }
    ...
    @Override
    public VectorOptions setSoftPendingCompactionBytesLimit(final long softPendingCompactionBytesLimit) {
        setSoftPendingCompactionBytesLimit(nativeHandle_, softPendingCompactionBytesLimit);
        return this;
    }
    ...
    @Override
    public VectorOptions setHardPendingCompactionBytesLimit(final long hardPendingCompactionBytesLimit) {
    ...
    @Override
    public VectorOptions setLevel0FileNumCompactionTrigger(final int level0FileNumCompactionTrigger) {
    ...
    @Override
    public VectorOptions setLevel0SlowdownWritesTrigger(final int level0SlowdownWritesTrigger) {
    ...
    @Override
    public VectorOptions setLevel0StopWritesTrigger(final int level0StopWritesTrigger) {
    ...
    @Override
    public VectorOptions setMaxBytesForLevelMultiplierAdditional(final int[] maxBytesForLevelMultiplierAdditional) {
    ...
    @Override
    public VectorOptions setParanoidFileChecks(final boolean paranoidFileChecks) {
    ...
    @Override
    public VectorOptions setMaxWriteBufferNumberToMaintain(final int maxWriteBufferNumberToMaintain) {
        setMaxWriteBufferNumberToMaintain(nativeHandle_, maxWriteBufferNumberToMaintain);
        return this;
    }
    ...
    @Override
    public VectorOptions setCompactionPriority(final CompactionPriority compactionPriority) {
    ...
    public CompactionPriority compactionPriority() {
        return CompactionPriority.getCompactionPriority(compactionPriority(nativeHandle_));
    }

    @Override
    public VectorOptions setReportBgIoStats(final boolean reportBgIoStats) {
    ...
    @Override
    public VectorOptions setTtl(final long ttl) {
    ...
    @Override
    public VectorOptions setPeriodicCompactionSeconds(final long periodicCompactionSeconds) {
    ...
    @Override
    public VectorOptions setCompactionOptionsUniversal(final CompactionOptionsUniversal compactionOptionsUniversal) {
        setCompactionOptionsUniversal(nativeHandle_, compactionOptionsUniversal.nativeHandle_);
    ...
    @Override
    public VectorOptions setCompactionOptionsFIFO(final CompactionOptionsFIFO compactionOptionsFIFO) {
        setCompactionOptionsFIFO(nativeHandle_, compactionOptionsFIFO.nativeHandle_);
    ...
    @Override
    public VectorOptions setForceConsistencyChecks(final boolean forceConsistencyChecks) {
    ...
    @Override
    public VectorOptions setAtomicFlush(final boolean atomicFlush) {
    ...
    @Override
    public VectorOptions setPersistStatsToDisk(final boolean persistStatsToDisk) {
    ...
    @Override
    public VectorOptions setWriteDbidToManifest(final boolean writeDbidToManifest) {
    ...
    @Override
    public VectorOptions setLogReadaheadSize(final long logReadaheadSize) {
    ...
    @Override
    public VectorOptions setBestEffortsRecovery(final boolean bestEffortsRecovery) {
    ...
    @Override
    public VectorOptions setMaxBgErrorResumeCount(final int maxBgerrorResumeCount) {
    ...
    @Override
    public VectorOptions setBgerrorResumeRetryInterval(final long bgerrorResumeRetryInterval) {
    ...
    @Override
    public VectorOptions setSstPartitionerFactory(final SstPartitionerFactory sstPartitionerFactory) {
    ...
    @Override
    public VectorOptions setCompactionThreadLimiter(final ConcurrentTaskLimiter compactionThreadLimiter) {
    ...
    @Override
    public VectorOptions setEnableBlobFiles(final boolean enableBlobFiles) {
    ...
    @Override
    public VectorOptions setMinBlobSize(final long minBlobSize) {
    ...
    @Override
    public VectorOptions setBlobFileSize(final long blobFileSize) {
    ...
    @Override
    public VectorOptions setBlobCompressionType(final CompressionType compressionType) {
    ...
    @Override
    public VectorOptions setEnableBlobGarbageCollection(final boolean enableBlobGarbageCollection) {
    ...
    @Override
    public VectorOptions setBlobGarbageCollectionAgeCutoff(final double blobGarbageCollectionAgeCutoff) {
    ...
    @Override
    public VectorOptions setBlobGarbageCollectionForceThreshold(final double blobGarbageCollectionForceThreshold) {
    ...
    @Override
    public VectorOptions setBlobCompactionReadaheadSize(final long blobCompactionReadaheadSize) {
    ...
    @Override
    public VectorOptions setBlobFileStartingLevel(final int blobFileStartingLevel) {
    ...
    @Override
    public VectorOptions setPrepopulateBlobCache(final PrepopulateBlobCache prepopulateBlobCache) {
    ...
    private native void setCreateMissingColumnFamilies(long handle, boolean flag);
    ...
    private native void setParanoidChecks(long handle, boolean paranoidChecks);
    ...
    private native void setMaxTotalWalSize(long handle, long maxTotalWalSize);

    private native void setMaxFileOpeningThreads(final long handle, final int maxFileOpeningThreads);
    ...
    private native void setDbPaths(final long handle, final String[] paths, final long[] targetSizes);

    private native long dbPathsLen(final long handle);

    private native void dbPaths(final long handle, final String[] paths, final long[] targetSizes);
    ...
    private native void setDeleteObsoleteFilesPeriodMicros(long handle, long micros);
    ...
    private native void setMaxLogFileSize(long handle, long maxLogFileSize) throws IllegalArgumentException;

    private native long maxLogFileSize(long handle);

    private native void setLogFileTimeToRoll(long handle, long logFileTimeToRoll) throws IllegalArgumentException;

    private native long logFileTimeToRoll(long handle);

    private native void setKeepLogFileNum(long handle, long keepLogFileNum) throws IllegalArgumentException;
    ...
    private native void setMaxManifestFileSize(long handle, long maxManifestFileSize);

    private native long maxManifestFileSize(long handle);

    private native void setMaxTableFilesSizeFIFO(long handle, long maxTableFilesSize);

    private native long maxTableFilesSizeFIFO(long handle);

    private native void setTableCacheNumshardbits(long handle, int tableCacheNumshardbits);
    ...
    private native void setManifestPreallocationSize(long handle, long size) throws IllegalArgumentException;
    ...
    private native void setUseDirectIoForFlushAndCompaction(long handle, boolean useDirectIoForFlushAndCompaction);
    ...
    private native void setAllowMmapReads(long handle, boolean allowMmapReads);

    private native boolean allowMmapReads(long handle);

    private native void setAllowMmapWrites(long handle, boolean allowMmapWrites);

    private native boolean allowMmapWrites(long handle);

    private native void setIsFdCloseOnExec(long handle, boolean isFdCloseOnExec);

    private native boolean isFdCloseOnExec(long handle);

    private native void setStatsDumpPeriodSec(long handle, int statsDumpPeriodSec);

    private native int statsDumpPeriodSec(long handle);

    private native void setStatsPersistPeriodSec(final long handle, final int statsPersistPeriodSec);

    private native int statsPersistPeriodSec(final long handle);

    private native void setStatsHistoryBufferSize(final long handle, final long statsHistoryBufferSize);

    private native long statsHistoryBufferSize(final long handle);

    private native void setAdviseRandomOnOpen(long handle, boolean adviseRandomOnOpen);

    private native boolean adviseRandomOnOpen(long handle);

    private native void setDbWriteBufferSize(final long handle, final long dbWriteBufferSize);

    private native void setWriteBufferManager(final long handle, final long writeBufferManagerHandle);

    private native long dbWriteBufferSize(final long handle);

    private native void setAccessHintOnCompactionStart(final long handle, final byte accessHintOnCompactionStart);

    private native byte accessHintOnCompactionStart(final long handle);

    private native void setCompactionReadaheadSize(final long handle, final long compactionReadaheadSize);

    private native long compactionReadaheadSize(final long handle);

    private native void setRandomAccessMaxBufferSize(final long handle, final long randomAccessMaxBufferSize);

    private native long randomAccessMaxBufferSize(final long handle);

    private native void setWritableFileMaxBufferSize(final long handle, final long writableFileMaxBufferSize);

    private native long writableFileMaxBufferSize(final long handle);

    private native void setUseAdaptiveMutex(long handle, boolean useAdaptiveMutex);

    private native boolean useAdaptiveMutex(long handle);

    private native void setBytesPerSync(long handle, long bytesPerSync);
    ...
    private native void setStrictBytesPerSync(final long handle, final boolean strictBytesPerSync);

    private native boolean strictBytesPerSync(final long handle);

    private native void setEnableThreadTracking(long handle, boolean enableThreadTracking);
    ...
    private native void setUnorderedWrite(final long handle, final boolean unorderedWrite);

    private native boolean unorderedWrite(final long handle);

    private native void setAllowConcurrentMemtableWrite(long handle, boolean allowConcurrentMemtableWrite);

    private native boolean allowConcurrentMemtableWrite(long handle);

    private native void setEnableWriteThreadAdaptiveYield(long handle, boolean enableWriteThreadAdaptiveYield);

    private native boolean enableWriteThreadAdaptiveYield(long handle);

    private native void setWriteThreadMaxYieldUsec(long handle, long writeThreadMaxYieldUsec);

    private native long writeThreadMaxYieldUsec(long handle);

    private native void setWriteThreadSlowYieldUsec(long handle, long writeThreadSlowYieldUsec);

    private native long writeThreadSlowYieldUsec(long handle);

    private native void setSkipStatsUpdateOnDbOpen(final long handle, final boolean skipStatsUpdateOnDbOpen);

    private native boolean skipStatsUpdateOnDbOpen(final long handle);

    private native void setWalRecoveryMode(final long handle, final byte walRecoveryMode);

    private native byte walRecoveryMode(final long handle);

    private native void setAllow2pc(final long handle, final boolean allow2pc);
    ...
    private native void setFailIfOptionsFileError(final long handle, final boolean failIfOptionsFileError);

    private native boolean failIfOptionsFileError(final long handle);

    private native void setDumpMallocStats(final long handle, final boolean dumpMallocStats);

    private native boolean dumpMallocStats(final long handle);

    private native void setAvoidFlushDuringRecovery(final long handle, final boolean avoidFlushDuringRecovery);

    private native boolean avoidFlushDuringRecovery(final long handle);

    private native void setAvoidFlushDuringShutdown(final long handle, final boolean avoidFlushDuringShutdown);
    ...
    private native void optimizeForPointLookup(long handle, long blockCacheSizeMb);

    private native void optimizeLevelStyleCompaction(long handle, long memtableMemoryBudget);

    private native void optimizeUniversalStyleCompaction(long handle, long memtableMemoryBudget);

    private native void setComparatorHandle(long handle, int builtinComparator);

    private native void setComparatorHandle(long optHandle, long comparatorHandle, byte comparatorType);
    ...
    private native void setCompactionFilterFactoryHandle(long handle, long compactionFilterFactoryHandle);

    private native void setWriteBufferSize(long handle, long writeBufferSize) throws IllegalArgumentException;
    ...
    private native void setMinWriteBufferNumberToMerge(long handle, int minWriteBufferNumberToMerge);
    ...
    private native void setCompressionPerLevel(long handle, byte[] compressionLevels);

    private native byte[] compressionPerLevel(long handle);

    private native void setBottommostCompressionType(long handle, byte bottommostCompressionType);
    ...
    private native void setCompressionOptions(long handle, long compressionOptionsHandle);

    private native void useFixedLengthPrefixExtractor(long handle, int prefixLength);

    private native void useCappedPrefixExtractor(long handle, int prefixLength);

    private native void setNumLevels(long handle, int numLevels);

    private native int numLevels(long handle);

    private native void setLevelZeroFileNumCompactionTrigger(long handle, int numFiles);

    private native int levelZeroFileNumCompactionTrigger(long handle);

    private native void setLevelZeroSlowdownWritesTrigger(long handle, int numFiles);

    private native int levelZeroSlowdownWritesTrigger(long handle);

    private native void setLevelZeroStopWritesTrigger(long handle, int numFiles);

    private native int levelZeroStopWritesTrigger(long handle);

    private native void setTargetFileSizeBase(long handle, long targetFileSizeBase);

    private native long targetFileSizeBase(long handle);

    private native void setTargetFileSizeMultiplier(long handle, int multiplier);

    private native int targetFileSizeMultiplier(long handle);

    private native void setMaxBytesForLevelBase(long handle, long maxBytesForLevelBase);

    private native long maxBytesForLevelBase(long handle);

    private native void setLevelCompactionDynamicLevelBytes(long handle,
                                                            boolean enableLevelCompactionDynamicLevelBytes);

    private native boolean levelCompactionDynamicLevelBytes(long handle);
    ...
    private native void setArenaBlockSize(long handle, long arenaBlockSize) throws IllegalArgumentException;

    private native long arenaBlockSize(long handle);

    private native void setDisableAutoCompactions(long handle, boolean disableAutoCompactions);
    ...
    private native void setMaxSequentialSkipInIterations(long handle, long maxSequentialSkipInIterations);
    ...
    private native void setInplaceUpdateSupport(long handle, boolean inplaceUpdateSupport);

    private native boolean inplaceUpdateSupport(long handle);

    private native void setInplaceUpdateNumLocks(long handle, long inplaceUpdateNumLocks) throws IllegalArgumentException;

    private native long inplaceUpdateNumLocks(long handle);

    private native void setMemtablePrefixBloomSizeRatio(long handle, double memtablePrefixBloomSizeRatio);

    private native double memtablePrefixBloomSizeRatio(long handle);

    private native void setExperimentalMempurgeThreshold(long handle, double experimentalMempurgeThreshold);
    ...
    private native void setBloomLocality(long handle, int bloomLocality);

    private native int bloomLocality(long handle);

    private native void setMaxSuccessiveMerges(long handle, long maxSuccessiveMerges) throws IllegalArgumentException;

    private native long maxSuccessiveMerges(long handle);

    private native void setOptimizeFiltersForHits(long handle, boolean optimizeFiltersForHits);

    private native boolean optimizeFiltersForHits(long handle);

    private native void setMemtableHugePageSize(long handle, long memtableHugePageSize);

    private native long memtableHugePageSize(long handle);

    private native void setSoftPendingCompactionBytesLimit(long handle, long softPendingCompactionBytesLimit);

    private native long softPendingCompactionBytesLimit(long handle);

    private native void setHardPendingCompactionBytesLimit(long handle, long hardPendingCompactionBytesLimit);

    private native long hardPendingCompactionBytesLimit(long handle);

    private native void setLevel0FileNumCompactionTrigger(long handle, int level0FileNumCompactionTrigger);

    private native int level0FileNumCompactionTrigger(long handle);

    private native void setLevel0SlowdownWritesTrigger(long handle, int level0SlowdownWritesTrigger);

    private native int level0SlowdownWritesTrigger(long handle);

    private native void setLevel0StopWritesTrigger(long handle, int level0StopWritesTrigger);
    ...
    private native void setParanoidFileChecks(long handle, boolean paranoidFileChecks);

    private native boolean paranoidFileChecks(long handle);

    private native void setMaxWriteBufferNumberToMaintain(final long handle, final int maxWriteBufferNumberToMaintain);

    private native int maxWriteBufferNumberToMaintain(final long handle);

    private native void setCompactionPriority(final long handle, final byte compactionPriority);

    private native byte compactionPriority(final long handle);

    private native void setReportBgIoStats(final long handle, final boolean reportBgIoStats);
    ...
    private native void setCompactionOptionsUniversal(final long handle, final long compactionOptionsUniversalHandle);

    private native void setCompactionOptionsFIFO(final long handle, final long compactionOptionsFIFOHandle);

    private native void setForceConsistencyChecks(final long handle, final boolean forceConsistencyChecks);
    ...
    private native void setEnableBlobGarbageCollection(final long nativeHandle_,
                                                       final boolean enableBlobGarbageCollection);

    private native boolean enableBlobGarbageCollection(final long nativeHandle_);

    private native void setBlobGarbageCollectionAgeCutoff(final long nativeHandle_,
                                                          final double blobGarbageCollectionAgeCutoff);

    private native double blobGarbageCollectionAgeCutoff(final long nativeHandle_);

    private native void setBlobGarbageCollectionForceThreshold(final long nativeHandle_,
    ...
    private native void setBlobCompactionReadaheadSize(final long nativeHandle_,
                                                       final long blobCompactionReadaheadSize);

    private native long blobCompactionReadaheadSize(final long nativeHandle_);

    private native void setBlobFileStartingLevel(final long nativeHandle_, final int blobFileStartingLevel);

    private native int blobFileStartingLevel(final long nativeHandle_);

    private native void setPrepopulateBlobCache(final long nativeHandle_, final byte prepopulateBlobCache);

    private native byte prepopulateBlobCache(final long nativeHandle_);

    // ------------- Additional vector options --------------------

    @Override
    public VectorOptions setMaxElements(long maxElements) {
    ...
    @Override
    public VectorOptions setM(long M) {
    ...
    @Override
    public VectorOptions setEfConstruction(long efConstruction) {
    ...
    @Override
    public VectorOptions setRandomSeed(long randomSeed) {
    ...
    @Override
    public VectorOptions setVisitListPoolSize(long visitListPoolSize) {
    ...
    @Override
    public VectorOptions setTerminationThreshold(float terminationThreshold) {
    ...
    @Override
    public VectorOptions setTerminationWeight(float terminationWeight) {
    ...
    @Override
    public VectorOptions setTerminationLowerBound(float terminationLowerBound) {
    ...
    @Override
    public VectorOptions setDim(long dim) {
    ...
    @Override
    public VectorOptions setSpace(SpaceType spaceType) {
    ...
    @Override
    public VectorOptions setAllowReplaceDeleted(boolean allowReplaceDeleted) {
