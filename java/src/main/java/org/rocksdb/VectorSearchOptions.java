...
public class VectorSearchOptions extends RocksObject {
    public VectorSearchOptions() {
        super(newVectorSearchOptions());
    }

    public VectorSearchOptions(final boolean verifyChecksums, final boolean fillCache) {
        super(newVectorSearchOptions(verifyChecksums, fillCache));
    }

    public VectorSearchOptions(final VectorSearchOptions other) {
        super(copyVectorSearchOptions(other.nativeHandle_));
    ...
    private static native long newVectorSearchOptions();

    private static native long newVectorSearchOptions(final boolean verifyChecksums, final boolean fillCache);

    private static native long copyVectorSearchOptions(long handle);

    private static native long k(long handle);

    private static native void setK(long handle, final long k);

    private static native long ts(long handle);

    private static native void setTs(long handle, final long ts);
        
    private static native boolean evict(long handle);

    private static native void setEvict(long handle, final boolean evict);

    // TODO(yhchiang): this option seems to be block-based table only.
    //                 move this to a better place?

    private static native boolean triggerSort(long handle);

    private static native void setTriggerSort(long handle, final boolean triggerSort);

    private static native float terminationFactor(long handle);

    private static native void setTerminationFactor(long handle, final float terminationFactor);

    private static native boolean searchSST(long handle);

    private static native void setSearchSST(long handle, final boolean searchSST);

    public long k() {
        return k(nativeHandle_);
    }

    public VectorSearchOptions setK(final long k) {
        setK(nativeHandle_, k);
        return this;
    }

    public long ts() {return ts(nativeHandle_);}

    public VectorSearchOptions setTs(final long ts) {
        setTs(nativeHandle_, ts);
        return this;
    }
    
    public boolean evict() {return evict(nativeHandle_);}

    public VectorSearchOptions setEvict(final boolean evict) {
        setEvict(nativeHandle_, evict);
        return this;
    }

    public boolean triggerSort() {
        return triggerSort(nativeHandle_);
    }

    public VectorSearchOptions setTriggerSort(final boolean triggerSort) {
        setTriggerSort(nativeHandle_, triggerSort);
        return this;
    }

    public float terminationFactor() {
        return terminationFactor(nativeHandle_);
    }

    public VectorSearchOptions setTerminationFactor(final float terminationFactor) {
        setTerminationFactor(nativeHandle_, terminationFactor);
        return this;
    }

    public boolean searchSST() { return searchSST(nativeHandle_); }

    public VectorSearchOptions setSearchSST(final boolean searchSST) {
        setSearchSST(nativeHandle_, searchSST);
        return this;
    }
     ...
     */
    public VectorSearchOptions setVerifyChecksums(
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setFillCache(final boolean fillCache) {
        assert(isOwningHandle());
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setSnapshot(final Snapshot snapshot) {
        assert(isOwningHandle());
        if (snapshot != null) {
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setReadTier(final ReadTier readTier) {
        assert(isOwningHandle());
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setTailing(final boolean tailing) {
        assert(isOwningHandle());
     ...
     */
    @Deprecated
    public VectorSearchOptions setManaged(final boolean managed) {
        assert(isOwningHandle());
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setTotalOrderSeek(final boolean totalOrderSeek) {
        assert(isOwningHandle());
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setPrefixSameAsStart(final boolean prefixSameAsStart) {
        assert(isOwningHandle());
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setPinData(final boolean pinData) {
        assert(isOwningHandle());
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setBackgroundPurgeOnIteratorCleanup(
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setReadaheadSize(final long readaheadSize) {
        assert(isOwningHandle());
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setMaxSkippableInternalKeys(
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setIgnoreRangeDeletions(final boolean ignoreRangeDeletions) {
        assert(isOwningHandle());
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setIterateLowerBound(final AbstractSlice<?> iterateLowerBound) {
        assert(isOwningHandle());
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setIterateUpperBound(final AbstractSlice<?> iterateUpperBound) {
        assert(isOwningHandle());
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setTableFilter(final AbstractTableFilter tableFilter) {
        assert(isOwningHandle());
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setAutoPrefixMode(final boolean mode) {
        assert (isOwningHandle());
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setTimestamp(final AbstractSlice<?> timestamp) {
        assert (isOwningHandle());
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setIterStartTs(final AbstractSlice<?> iterStartTs) {
        assert (isOwningHandle());
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setDeadline(final long deadlineTime) {
        assert (isOwningHandle());
     ...
     * @return the reference to the current ReadOptions.
     */
    public VectorSearchOptions setIoTimeout(final long ioTimeout) {
        assert (isOwningHandle());
     ...
     * @return the reference to the current ReadOptions
     */
    public VectorSearchOptions setValueSizeSoftLimit(final long valueSizeSoftLimit) {
        assert (isOwningHandle());
    ...
    public VectorSearchOptions setAsyncIO(final boolean asyncIo) {
        assert (isOwningHandle());
