...
public class RocksDB extends RocksObject {
  ...
  public static final String vectorCFExtension = "Ext";

  private final List<ColumnFamilyHandle> ownedColumnFamilyHandles = new ArrayList<>();
  private final List<VectorColumnFamilyHandle> ownedVectorColumnFamilyHandles = new ArrayList<>();
  private final Map<VectorColumnFamilyHandle, ColumnFamilyHandle> exColumnFamilyHandles = new HashMap<>();
  ...
  public static RocksDB open(final DBOptions options, final String path,
      ...
      for (int i = 0; i < vcfnum; i++) {
        ...
        System.arraycopy(cfName, 0, vectorCFDescriptor.getName(), 0, vectorCFDescriptor.getName().length);
        System.arraycopy(cfName, vectorCFDescriptor.getName().length, vectorCFExtension.getBytes(), 0, vectorCFExtension.length());
  ...
  public void closeE() throws RocksDBException {
    ...
    for (final VectorColumnFamilyHandle vectorColumnFamilyHandle : ownedVectorColumnFamilyHandles) {
      vectorColumnFamilyHandle.close();
    }
    ownedVectorColumnFamilyHandles.clear();

    for (final ColumnFamilyHandle columnFamilyHandle : exColumnFamilyHandles.values()) {
      columnFamilyHandle.close();
    }
    exColumnFamilyHandles.clear();
  ...
  /**
   * Creates a new vector column family with the name columnFamilyName and
   * allocates a VectorColumnFamilyHandle within an internal structure.
   * The VectorColumnFamilyHandle is automatically disposed with DB disposal.
   *
   * @param vectorColumnFamilyDescriptor column family to be created.
   * @return {@link org.rocksdb.VectorColumnFamilyHandle} instance.
   *
   * @throws RocksDBException thrown if error happens in underlying
   *    native library.
   */
  public VectorColumnFamilyHandle createVectorColumnFamily(
          final VectorCFDescriptor vectorColumnFamilyDescriptor)
          throws RocksDBException {
    return createVectorColumnFamily(vectorColumnFamilyDescriptor, new ColumnFamilyOptions());
  }
   ...
   *
   * @param vectorColumnFamilyDescriptor column family to be created.
   * @param columnFamilyOptions options of extended column family to store version to be created.
   * @return {@link org.rocksdb.VectorColumnFamilyHandle} instance.
   *
   * @throws RocksDBException thrown if error happens in underlying
   *    native library.
   */
  public VectorColumnFamilyHandle createVectorColumnFamily(
          final VectorCFDescriptor vectorColumnFamilyDescriptor, final ColumnFamilyOptions columnFamilyOptions)
          throws RocksDBException {
      final VectorColumnFamilyHandle vectorColumnFamilyHandle =
              new VectorColumnFamilyHandle(this, createVectorColumnFamily(
                      nativeHandle_,
                      vectorColumnFamilyDescriptor.getName(),
                      vectorColumnFamilyDescriptor.getName().length,
                      vectorColumnFamilyDescriptor.getOptions().nativeHandle_));
      ownedVectorColumnFamilyHandles.add(vectorColumnFamilyHandle);
      // columnFamilyName = vectorColumnFamilyName + vectorCFExtension
      final byte[] columnFamilyName =
              new byte[vectorColumnFamilyDescriptor.getName().length + vectorCFExtension.getBytes().length];
      System.arraycopy(vectorColumnFamilyDescriptor.getName(), 0, columnFamilyName, 0,
              vectorColumnFamilyDescriptor.getName().length);
      System.arraycopy(vectorCFExtension.getBytes(), 0, columnFamilyName,
              vectorColumnFamilyDescriptor.getName().length, vectorCFExtension.getBytes().length);
      final ColumnFamilyHandle columnFamilyHandle =
              new ColumnFamilyHandle(this, createColumnFamily(
                      nativeHandle_,
                      columnFamilyName,
                      columnFamilyName.length,
                      columnFamilyOptions.nativeHandle_));
      exColumnFamilyHandles.put(vectorColumnFamilyHandle, columnFamilyHandle);
      return vectorColumnFamilyHandle;
  }
  ...
  /**
   * Bulk create vector column families with the same vector column family options.
   *
   * @param vectorColumnFamilyOptions the options for the column families.
   * @param columnFamilyNames the names of the column families.
   *
   * @return the handles to the newly created column families.
   *
   ...
   *     the column families
   */
  public List<VectorColumnFamilyHandle> createVectorColumnFamilies(
      final VectorColumnFamilyOptions vectorColumnFamilyOptions,
      final List<byte[]> columnFamilyNames) throws RocksDBException {
    return createVectorColumnFamilies(vectorColumnFamilyOptions, new ColumnFamilyOptions(), columnFamilyNames);
  }
  ...
  public List<VectorColumnFamilyHandle> createVectorColumnFamilies(
      ...
      final byte[][] cfNames = columnFamilyNames.toArray(
              new byte[0][]);
      List<byte[]> cfNamesWithExtension = new ArrayList<>(cfNames.length);
      for (byte[] cfName : cfNames) {
          final byte[] columnFamilyName =
                  new byte[cfName.length + vectorCFExtension.getBytes().length];
          System.arraycopy(cfName, 0, columnFamilyName, 0, cfName.length);
          System.arraycopy(vectorCFExtension.getBytes(), 0, columnFamilyName,
                           cfName.length, vectorCFExtension.getBytes().length);
          cfNamesWithExtension.add(columnFamilyName);
      }
      final byte[][] cfNamesWithExtensionArray = cfNamesWithExtension.toArray(
              new byte[0][]);
      final long[] vcfHandles = createVectorColumnFamilies(nativeHandle_,
                                                           vectorColumnFamilyOptions.nativeHandle_, cfNames);
      final long[] cfHandles = createColumnFamilies(nativeHandle_, columnFamilyOptions.nativeHandle_, cfNamesWithExtensionArray);
      final List<VectorColumnFamilyHandle> vectorColumnFamilyHandles =
              new ArrayList<>(vcfHandles.length);
      for (int i = 0; i < vcfHandles.length; i++){
          final VectorColumnFamilyHandle vectorColumnFamilyHandle = new VectorColumnFamilyHandle(this, vcfHandles[i]);
          vectorColumnFamilyHandles.add(vectorColumnFamilyHandle);
          final ColumnFamilyHandle columnFamilyHandle = new ColumnFamilyHandle(this, cfHandles[i]);
          exColumnFamilyHandles.put(vectorColumnFamilyHandle, columnFamilyHandle);
      }
      ownedVectorColumnFamilyHandles.addAll(vectorColumnFamilyHandles);
      return vectorColumnFamilyHandles;
  }
   ...
   * Bulk create vector column families with the same vector column family options.
   *
   * @param vectorColumnFamilyDescriptors the descriptions of the column families.
   *
   * @return the handles to the newly created column families.
   *
   * @throws RocksDBException if an error occurs whilst creating
   ...
   */
  public List<VectorColumnFamilyHandle> createVectorColumnFamilies(
      final List<VectorCFDescriptor> vectorColumnFamilyDescriptors)
      throws RocksDBException {
    final long[] vcfOptsHandles = new long[vectorColumnFamilyDescriptors.size()];
    final long[] cfOptsHandles = new long[vectorColumnFamilyDescriptors.size()];
    final byte[][] vcfNames = new byte[vectorColumnFamilyDescriptors.size()][];
    final byte[][] cfNames = new byte[vectorColumnFamilyDescriptors.size()][];
    for (int i = 0; i < vectorColumnFamilyDescriptors.size(); i++) {
      final VectorCFDescriptor vectorColumnFamilyDescriptor
          = vectorColumnFamilyDescriptors.get(i);
      vcfOptsHandles[i] = vectorColumnFamilyDescriptor.getOptions().nativeHandle_;
      cfOptsHandles[i] = new ColumnFamilyOptions().nativeHandle_;
      vcfNames[i] = vectorColumnFamilyDescriptor.getName();
      cfNames[i] = new byte[vcfNames[i].length + vectorCFExtension.getBytes().length];
      System.arraycopy(vcfNames[i], 0, cfNames[i], 0, vcfNames[i].length);
      System.arraycopy(vectorCFExtension.getBytes(), 0, cfNames[i],
                       vcfNames[i].length, vectorCFExtension.getBytes().length);
    }
    final long[] vcfHandles = createVectorColumnFamilies(nativeHandle_,
        vcfOptsHandles, vcfNames);
    final long[] cfHandles = createColumnFamilies(nativeHandle_,
        cfOptsHandles, cfNames);
    final List<VectorColumnFamilyHandle> vectorColumnFamilyHandles =
        new ArrayList<>(vcfHandles.length);
  ...
  public void dropVectorColumnFamily(final VectorColumnFamilyHandle columnFamilyHandle)
      throws RocksDBException {
    dropColumnFamily(nativeHandle_, columnFamilyHandle.nativeHandle_);
    ColumnFamilyHandle cfHandle = exColumnFamilyHandles.get(columnFamilyHandle);
    if (cfHandle!= null) {
      dropColumnFamily(nativeHandle_, cfHandle.nativeHandle_);
    }
  }
  ...
  public void dropColumnFamilies(
    ...
    public void dropVectorColumnFamilies(
            final List<VectorColumnFamilyHandle> columnFamilies) throws RocksDBException {
        final long[] vcfHandles = new long[columnFamilies.size()];
        final long[] cfHandles = new long[columnFamilies.size()];
        for (int i = 0; i < columnFamilies.size(); i++) {
            vcfHandles[i] = columnFamilies.get(i).nativeHandle_;
            cfHandles[i] = exColumnFamilyHandles.get(columnFamilies.get(i)).nativeHandle_;
        }
        dropColumnFamilies(nativeHandle_, vcfHandles);
        dropColumnFamilies(nativeHandle_, cfHandles);
    }
  ...
  /**
   * Deletes native vector column family handle of given {@link VectorColumnFamilyHandle} Java object
   * and removes reference from {@link RocksDB#ownedVectorColumnFamilyHandles}.
   *
   * @param vectorColumnFamilyHandle column family handle object.
   */
  public void destroyVectorColumnFamilyHandle(final VectorColumnFamilyHandle vectorColumnFamilyHandle) {
    for (int i = 0; i < ownedVectorColumnFamilyHandles.size(); ++i) {
      final VectorColumnFamilyHandle ownedHandle = ownedVectorColumnFamilyHandles.get(i);
      if (ownedHandle.equals(vectorColumnFamilyHandle)) {
          final ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
          if (columnFamilyHandle!= null) {
            columnFamilyHandle.close();
            exColumnFamilyHandles.remove(vectorColumnFamilyHandle);
          }
        vectorColumnFamilyHandle.close();
        ownedVectorColumnFamilyHandles.remove(i);
        return;
      }
    }
  }
  ...
  /**
   * Set the database entry for "key" to "value" in the specified
   * vector column family.
   *
   * @param vectorColumnFamilyHandle {@link org.rocksdb.VectorColumnFamilyHandle}
   *     instance
   * @param key the specified key to be inserted.
   * @param value the value associated with the specified key.
   * <p>
   ...
   *    native library.
   */
  public void put(final VectorColumnFamilyHandle vectorColumnFamilyHandle,
                  final byte[] key, final byte[] value) throws RocksDBException {
    ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
    putVector(nativeHandle_, key, 0, key.length, value, 0, value.length,
              vectorColumnFamilyHandle.nativeHandle_, columnFamilyHandle.nativeHandle_);
  }
  ...
  public void put(final VectorColumnFamilyHandle vectorColumnFamilyHandle,
    ...
    checkBounds(vOffset, vLen, value.length);
    ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
    putVector(nativeHandle_, key, offset, len, value, vOffset, vLen,
        vectorColumnFamilyHandle.nativeHandle_, columnFamilyHandle.nativeHandle_);
  }
  ...
  public void put(final VectorColumnFamilyHandle vectorColumnFamilyHandle,
      ...
      final byte[] value) throws RocksDBException {
    ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
    putVector(nativeHandle_, writeOpts.nativeHandle_, key, 0, key.length, value,
        0, value.length, vectorColumnFamilyHandle.nativeHandle_, columnFamilyHandle.nativeHandle_);
  }
  ...
  public void put(final VectorColumnFamilyHandle vectorColumnFamilyHandle,
    ...
    checkBounds(vOffset, vLen, value.length);
    ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
    putVector(nativeHandle_, writeOpts.nativeHandle_, key, offset, len, value,
        vOffset, vLen, vectorColumnFamilyHandle.nativeHandle_, columnFamilyHandle.nativeHandle_);
  }
   ...
   *    native library.
   */
  public void delete(final VectorColumnFamilyHandle vectorColumnFamilyHandle,
      final byte[] key) throws RocksDBException {
    ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
    deleteVector(nativeHandle_, key, 0, key.length, vectorColumnFamilyHandle.nativeHandle_, columnFamilyHandle.nativeHandle_);
  }
  ...
  public void delete(final VectorColumnFamilyHandle vectorColumnFamilyHandle,
      ...
      throws RocksDBException {
    ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
    deleteVector(nativeHandle_, key, offset, len, vectorColumnFamilyHandle.nativeHandle_, columnFamilyHandle.nativeHandle_);
  }
  ...
  public void delete(final VectorColumnFamilyHandle vectorColumnFamilyHandle,
      ...
      throws RocksDBException {
    ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
    deleteVector(nativeHandle_, writeOpt.nativeHandle_, key, 0, key.length,
        vectorColumnFamilyHandle.nativeHandle_, columnFamilyHandle.nativeHandle_);
  }
  ...
  public void delete(final VectorColumnFamilyHandle vectorColumnFamilyHandle,
      ...
      final int len)  throws RocksDBException {
    ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
    deleteVector(nativeHandle_, writeOpt.nativeHandle_, key, offset, len,
        vectorColumnFamilyHandle.nativeHandle_, columnFamilyHandle.nativeHandle_);
  }
  ...
  /**
   * Search the nearest vectors to the specified vector within column family.
   *
   * @param vectorColumnFamilyHandle {@link org.rocksdb.VectorColumnFamilyHandle}
   *     instance
   * @param key the key to retrieve the value.
   ...
   *    native library.
   */
  public int vectorSearch(final VectorColumnFamilyHandle vectorColumnFamilyHandle, final byte[] key,
      final byte[] value) throws RocksDBException, IllegalArgumentException {
    ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
    return vectorSearch(nativeHandle_, key, 0, key.length, value, 0, value.length,
        vectorColumnFamilyHandle.nativeHandle_, columnFamilyHandle.nativeHandle_);
  }
   ...
   * @param vectorColumnFamilyHandle {@link org.rocksdb.VectorColumnFamilyHandle}
   *     instance
   * @param opt {@link org.rocksdb.VectorSearchOptions} instance.
   * @param key the key to retrieve the value.
   * @param value the out-value to receive the retrieved value.
   * @return The size of the actual value that matches the specified
   *     {@code key} in byte.  If the return value is greater than the
   ...
   *    native library.
   */
  public int vectorSearch(final VectorColumnFamilyHandle vectorColumnFamilyHandle,
      final VectorSearchOptions opt, final byte[] key, final byte[] value)
      throws RocksDBException {
    ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
    return vectorSearch(nativeHandle_, opt.nativeHandle_, key, 0, key.length, value,
        0, value.length, vectorColumnFamilyHandle.nativeHandle_, columnFamilyHandle.nativeHandle_);
  }
   ...
   */
  public int vectorSearch(final VectorColumnFamilyHandle vectorColumnFamilyHandle,
      final VectorSearchOptions opt, final byte[] key, final int offset, final int len,
      final byte[] value, final int vOffset, final int vLen)
      throws RocksDBException {
    checkBounds(offset, len, key.length);
    checkBounds(vOffset, vLen, value.length);
    ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
    return vectorSearch(nativeHandle_, opt.nativeHandle_, key, offset, len, value,
        vOffset, vLen, vectorColumnFamilyHandle.nativeHandle_, columnFamilyHandle.nativeHandle_);
  }
  ...
  /**
   * The simplified version of vectorSearch which returns a new byte array storing
   * the nearest vectors to the specified vector within column family. null will be
   * returned if the nearest vectors are not found.
   *
   * @param vectorColumnFamilyHandle {@link org.rocksdb.VectorColumnFamilyHandle}
   *     instance
   * @param key the key retrieve the value.
   ...
   *    native library.
   */
  public byte[] vectorSearch(final VectorColumnFamilyHandle vectorColumnFamilyHandle,
      final byte[] key) throws RocksDBException {
    ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
    return vectorSearch(nativeHandle_, key, 0, key.length,
        vectorColumnFamilyHandle.nativeHandle_, columnFamilyHandle.nativeHandle_);
  }
  ...
  public byte[] vectorSearch(final VectorColumnFamilyHandle vectorColumnFamilyHandle,
    ...
    checkBounds(offset, len, key.length);
    ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
    return vectorSearch(nativeHandle_, key, offset, len,
        vectorColumnFamilyHandle.nativeHandle_, columnFamilyHandle.nativeHandle_);
  }
  ...
  /**
   * The simplified version of get which returns a new byte array storing   * the value associated with the
   * specified input key if any.  null will be
   * returned if the specified key is not found.
   *
   * @param vectorColumnFamilyHandle {@link org.rocksdb.VectorColumnFamilyHandle}
   ...
   */
  public byte[] vectorSearch(final VectorColumnFamilyHandle vectorColumnFamilyHandle,
      final VectorSearchOptions opt, final byte[] key) throws RocksDBException {
    ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
    return vectorSearch(nativeHandle_, opt.nativeHandle_, key, 0, key.length,
               vectorColumnFamilyHandle.nativeHandle_, columnFamilyHandle.nativeHandle_);
  }
  ...
  public byte[] vectorSearch(final VectorColumnFamilyHandle vectorColumnFamilyHandle,
    ...
    checkBounds(offset, len, key.length);
    ColumnFamilyHandle columnFamilyHandle = exColumnFamilyHandles.get(vectorColumnFamilyHandle);
    return vectorSearch(nativeHandle_, opt.nativeHandle_, key, offset, len,
        vectorColumnFamilyHandle.nativeHandle_, columnFamilyHandle.nativeHandle_);
  }
  ...
  public String getProperty(
    ...
    return getProperty(nativeHandle_, columnFamilyHandle.nativeHandle_,
  ...
  public String getProperty(
      final VectorColumnFamilyHandle vectorColumnFamilyHandle,
      final String property) throws RocksDBException {
    return getProperty(nativeHandle_, vectorColumnFamilyHandle.nativeHandle_,
        property, property.length());
  }
  ...
  public String getProperty(final String property) throws RocksDBException {
    return getProperty(nativeHandle_, 0, property, property.length());
  }
  ...
  /**
   * Change the options for the vector column family handle.
   *
   * @param vectorColumnFamilyHandle {@link org.rocksdb.VectorColumnFamilyHandle}
   *     instance, or null for the default column family.
   * @param mutableVectorColumnFamilyOptions the options.
   *
   * @throws RocksDBException if an error occurs whilst setting the options
   */
  public void SetVectorOptions(
      /* @Nullable */final VectorColumnFamilyHandle vectorColumnFamilyHandle,
      final MutableVectorColumnFamilyOptions mutableVectorColumnFamilyOptions)
      throws RocksDBException {
    setVectorOptions(nativeHandle_, vectorColumnFamilyHandle == null ? 0 : vectorColumnFamilyHandle.nativeHandle_,
        mutableVectorColumnFamilyOptions.getKeys(), mutableVectorColumnFamilyOptions.getValues());
  }
  ...
  /**
   * Get the options for the vector column family handle
   *
   * @param vectorColumnFamilyHandle {@link org.rocksdb.VectorColumnFamilyHandle} instance
   *
   * @return the options parsed from the options string return by RocksDB
   *
   * @throws RocksDBException if an error occurs while getting the options string, or parsing the
   *     resulting options string into options
   */
  public MutableVectorColumnFamilyOptions.MutableVectorColumnFamilyOptionsBuilder getVectorOptions(
          final VectorColumnFamilyHandle vectorColumnFamilyHandle) throws RocksDBException {
    final String optionsString = getVectorOptions(
            nativeHandle_, vectorColumnFamilyHandle.nativeHandle_);
    return MutableVectorColumnFamilyOptions.parse(optionsString, true);
  }
  ...
  public void flush(final FlushOptions flushOptions,
      final VectorColumnFamilyHandle vectorColumnFamilyHandle)
      throws RocksDBException {
    flushVectorColumnFamilies(flushOptions, Collections.singletonList(vectorColumnFamilyHandle));
  }
   ...
   * <p>
   * If atomic flush is not enabled, this is equivalent to calling
   * {@link #flush(FlushOptions, VectorColumnFamilyHandle)} multiple times.
   * <p>
   * If atomic flush is enabled, this will flush all column families
   * specified up to the latest sequence number at the time when flush is
   * requested.
   *
   * @param flushOptions {@link org.rocksdb.FlushOptions} instance.
   * @param vectorColumnFamilyHandles column family handles.
   * @throws RocksDBException thrown if an error occurs within the native
   *     part of the library.
   */
  public void flushVectorColumnFamilies(final FlushOptions flushOptions,
      /* @Nullable */ final List<VectorColumnFamilyHandle> vectorColumnFamilyHandles)
      throws RocksDBException {
    flush(nativeHandle_, flushOptions.nativeHandle_,
        toNativeHandleList(vectorColumnFamilyHandles));
  }
  ...
  private native long createColumnFamily(final long handle,
      ...
      final long columnFamilyOptions) throws RocksDBException;
  private native long createVectorColumnFamily(final long handle,
      final byte[] columnFamilyName, final int columnFamilyNamelen,
      final long columnFamilyOptions) throws RocksDBException;
  private native long[] createColumnFamilies(final long handle,
      ...
      throws RocksDBException;
  private native long[] createVectorColumnFamilies(final long handle,
      final long columnFamilyOptionsHandle, final byte[][] columnFamilyNames)
      throws RocksDBException;
  private native long[] createColumnFamilies(
      ...
      throws RocksDBException;
  private native long[] createVectorColumnFamilies(
      final long handle, final long[] columnFamilyOptionsHandles, final byte[][] columnFamilyNames)
      throws RocksDBException;
  ...
  private native void putVector(final long handle, final byte[] key, final int keyOffset,
                          final int keyLength, final byte[] value, final int valueOffset,
                          final int valueLength, final long vcfHandle, final long cfHandle) throws RocksDBException;
  ...
  private native void putVector(final long handle, final long writeOptHandle,
      final byte[] key, final int keyOffset, final int keyLength,
      final byte[] value, final int valueOffset, final int valueLength,
      final long vcfHandle, final long cfHandle) throws RocksDBException;
  ...
  private native void delete(final long handle, final byte[] key,
      ...
      throws RocksDBException;
  private native void deleteVector(final long handle, final byte[] key,
      final int keyOffset, final int keyLength, final long vcfHandle, final long cfHandle)
      throws RocksDBException;
  ...
  private native void delete(final long handle, final long writeOptHandle,
      final byte[] key, final int keyOffset, final int keyLength,
      final long cfHandle) throws RocksDBException;
  private native void deleteVector(final long handle, final long writeOptHandle,
      final byte[] key, final int keyOffset, final int keyLength,
      final long vcfHandle, final long cfHandle) throws RocksDBException;
  ...
  private native int get(final long handle, final byte[] key,
      ...
      final int valueOffset, final int valueLength, final long cfHandle)
      throws RocksDBException;
  private native int vectorSearch(final long handle, final byte[] key,
      final int keyOffset, final int keyLength, byte[] value,
      final int valueOffset, final int valueLength, final long vcfHandle, final long cfHandle)
      throws RocksDBException;
  ...
  private native int get(final long handle, final long readOptHandle,
      ...
      final byte[] value, final int valueOffset, final int valueLength,
      final long cfHandle) throws RocksDBException;
  private native int vectorSearch(final long handle, final long vectorSearchOptHandle,
      final byte[] key, final int keyOffset, final int keyLength,
      final byte[] value, final int valueOffset, final int valueLength,
      final long vcfHandle, final long cfHandle) throws RocksDBException;
  ...
  private native byte[] get(final long handle, final byte[] key,
      final int keyOffset, final int keyLength, final long cfHandle)
      throws RocksDBException;
  private native byte[] vectorSearch(final long handle, final byte[] key,
      final int keyOffset, final int keyLength, final long vcfHandle, final long cfHandle)
      throws RocksDBException;
  ...
  private native byte[] vectorSearch(final long handle,
      final long vectorSearchOptHandle, final byte[] key, final int keyOffset,
      final int keyLength, final long vcfHandle, final long cfHandle) throws RocksDBException;
  ...
  private native void setVectorOptions(final long handle, final long cfHandle,
      final String[] keys, final String[] values) throws RocksDBException;
  private native String getOptions(final long handle, final long cfHandle);
  private native String getVectorOptions(final long handle, final long cfHandle);
