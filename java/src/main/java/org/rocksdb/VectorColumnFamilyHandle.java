...
/**
 * VectorColumnFamilyHandle class to hold handles to underlying rocksdb
 * VectorColumnFamily Pointers.
 */
public class VectorColumnFamilyHandle extends RocksObject {
  /**
   ...
   * @param nativeHandle native handle to underlying native VectorColumnFamily object
   */
  VectorColumnFamilyHandle(final RocksDB rocksDB,
   ...
   * likely already had a VectorColumnFamilyHandle Java object which owns the underlying C++ object, as
   ...
   */
  VectorColumnFamilyHandle(final long nativeHandle) {
    super(nativeHandle);
    rocksDB_ = null;
    disOwnNativeHandle();
  }
  ...
  /**
   * Gets the name of the Vector Column Family.
   *
   * @return The name of the Vector Column Family.
   *
  ...
  /**
   * Gets the ID of the Vector Column Family.
   *
   * @return the ID of the Vector Column Family.
   */
  public int getID() {
    assert(isOwningHandle() || isDefaultColumnFamily());
   ...
   * access the up-to-date VCF options. In addition, all the pointer-typed
   ...
   *     descriptor.
   */
  public VectorCFDescriptor getDescriptor() throws RocksDBException {
    assert(isOwningHandle() || isDefaultColumnFamily());
  ...
  public boolean equals(final Object o) {
    ...
    final VectorColumnFamilyHandle that = (VectorColumnFamilyHandle) o;
    try {
  ...
  private native VectorCFDescriptor getDescriptor(final long handle) throws RocksDBException;
