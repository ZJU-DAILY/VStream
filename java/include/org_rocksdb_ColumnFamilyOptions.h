 ...
 * Signature: (JI)V
 */
JNIEXPORT void JNICALL Java_org_rocksdb_ColumnFamilyOptions_setFlushThreshold
  (JNIEnv *, jobject, jlong, jint);
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_org_rocksdb_ColumnFamilyOptions_flushThreshold
  (JNIEnv *, jobject, jlong);
